...
<script type="text/javascript">
	function deleteConfirm(id) {
		if (confirm("해당 회원을 삭제합니다!!") == true)
			location.href = "../sql/membership/processDelete.jsp?id=" + id;
		else
			location.href = "membershipSelect.jsp";
	}
</script>
...
<body>
	...
	<%!String greeting = "MembershipDelete";%>
	...
	<div class="container">
		...
		<form name="newProduct" class="form-horizontal" method="post">
			...
			<div class="form-group row">
				...
				<div class="col-sm-3">
					<input type="text" name="member" class="form-control" value='<%=rs.getString("m_id")%>'>
				</div>
			</div>
			...
			<div class="form-group row">
				<div class="col-sm-offset-2 col-sm-10 ">
					<a href="#" onclick="deleteConfirm('<%=rs.getString("m_id")%>')" class="btn btn-danger" role="button">삭제 &raquo;></a>
					<a href="#" onclick="location.href='./membershipSelect.jsp';" class="btn btn-primary" role="button">취소 &raquo;></a>
				</div>
			</div>
		</form>
	</div>
